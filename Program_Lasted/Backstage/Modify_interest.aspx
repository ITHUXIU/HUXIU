...
<script type="text/javascript">
       ...
       时间：<br /> <asp:TextBox ID="txtTime" runat="server" ></asp:TextBox><br />
        点赞数：<br /><asp:TextBox ID="txtLike" runat="server"  onkeyup="this.value=this.value.replace(/\D/g,'')" ></asp:TextBox><br />
        URL地址<br />：<asp:TextBox ID="txtUrl" runat="server" onbulr="check()"></asp:TextBox><br />
           <script>
                  function check() {                 
