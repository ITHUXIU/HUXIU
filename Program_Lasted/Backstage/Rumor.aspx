...
<body>
    ...
    <asp:Repeater ID="rptRumor" runat="server" OnItemCommand="rptRumor_ItemCommand" OnItemDataBound="rptRumor_ItemDataBound">
        <ItemTemplate>
           <tr> 
            ...
            <td><asp:Label ID="lbRumorContent" runat="server" Text=' <%#Eval("rumor_content") %>'></asp:Label></td>
               <td><%#Eval("rumor_time").ToString().Substring(0,10) %></td>
