        ...
        <div>
            <asp:Repeater ID="rptNews" runat="server" OnItemCommand="rptNews_ItemCommand" OnItemDataBound="rptNews_ItemDataBound">
                ...
                <ItemTemplate>
                    ...
                    <tr>
                    <th><%# Eval("News_id") %></th>
                    <th><a href='<%#"../Front-end/zixunCont-master/News_Content.aspx?news_id="+ Eval("news_id") %>'><img src='<%# Eval("News_cover") %>' runat="server" width="60" height="60" /></a></th>
                    <th><h3><a href='<%#"../Front-end/zixunCont-master/News_Content.aspx?news_id="+ Eval("news_id") %>'><%# Eval("News_title") %></a></h3></th>
