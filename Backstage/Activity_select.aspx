<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Activity_select.aspx.cs" Inherits="Backstage_Activity_select" %>
        ...
        <ItemTemplate>
           <tr> 
            ...
            <td><%#Eval("activity_end") %></td> 
              <td> <asp:Label ID="lbActivityClass" runat="server" Text='<%#Eval("activity_class") %>'></asp:Label></td>                                           
